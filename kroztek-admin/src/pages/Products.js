    ...
    return (
        <div className='container mt-5'>
            <div style={{ background: " #ffffff", color: "#525", position: "relative", padding: "5px 15px", display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "0.9rem" }}>
                ...
                <button onClick={() => navigate("/add-product")} type="button" class="btn " style={{ borderColor: "#511", display: "flex", gap: "10px", color: "#511", alignItems: "center", justifyContent: "space-between" }}>
                    <Add />
                    Add Product</button>
            </div>
